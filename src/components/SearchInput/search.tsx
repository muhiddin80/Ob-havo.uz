  ...
  return (
    <div className="relative w-[600px]">
      <form onSubmit={handleSubmit}>
        <div className="relative">
          <input
            ...
            className="w-full p-3 pl-12 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-400 bg-[#D9D9D9]"
          />
      ...
      {suggestions.length > 0 && (
        <ul className="absolute z-10 w-full bg-white border border-gray-300 rounded mt-1 max-h-52 overflow-auto">
